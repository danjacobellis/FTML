def build():
    ...
    result = run("jupyter-nbconvert --to slides critique_50y_fairness.ipynb --output docs\critique_50y_fairness --TagRemovePreprocessor.enabled=True --TagRemovePreprocessor.remove_cell_tags='remove-nb-cell'",capture_output=True)
    print(result.stdout.decode("utf-8"))
